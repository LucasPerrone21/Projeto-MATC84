    ...
    <div class="container-fluid px-4 px-lg-5">
      ...
      <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
        <ul class="navbar-nav gap-5 align-items-center">
          ...
          <li class="nav-item">
            <a class="nav-link text-white fw-bold" href="/cadastrar-filme">Cadastro de filmes</a>
          </li>
          ...
          <li class="nav-item">
            <button type="button" class="btn btn-primary fw-bold border-0" data-toggle="modal" data-target="#exitModal" style="background: #4248F2 !important">
                Sair
            </button>
