...
<div class="container d-flex flex-column justify-content-center align-items-center" style="min-height: 70vh; gap: 32px">
    <div class="text-center" style="width: 360px">
        ...
        <p style="color: #FFFFFF; font-size: 16px; font-family: 'Inter', sans-serif; font-weight: 200">Seus filmes favoritos a um clique de distância</p>
    </div>
    <div class="col-md-6 register d-flex justify-content-center ">
        ...
        @csrf
            <div class="form-group">
                <div class="mb-2">
                    <label class="text-white" for="name" style="color: #FFFFFF">Nome <span style="color: #DC3545">*</span></label>
                </div>
                <div class="mb-2">
                    <input type="text" id="name" name="name" placeholder="Insira seu nome" style="width: 360px" required>
                </div>
            </div>
            <div class="form-group">
                <div class="mb-2">
            ...
            <div class="form-group">
                ...
                <button type="submit" class="btn btn-primary" style="background: #4248F2; width: 360px; height: 38px">CRIAR CONTA</button>
        </form>
    </div>
    <div>
